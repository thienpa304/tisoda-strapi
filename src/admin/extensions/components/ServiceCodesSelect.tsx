...
export const ServiceSelectInput = React.forwardRef<HTMLInputElement, ServiceSelectInputProps>(
  (props, ref) => {
    const {
      name,
      value = '',
    ...
    if (loading) {
      return (
        <Box>
          <MultiSelect disabled placeholder="Loading services..." value={[]} onChange={() => {}} />
        </Box>
      );
    }
