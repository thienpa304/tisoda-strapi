import { Box, MultiSelect, MultiSelectOption, Typography } from '@strapi/design-system';
...
export const MultiSelectInput = React.forwardRef<HTMLInputElement, MultiSelectInputProps>(
  (props, ref) => {
    const {
      name,
      value = [],
