...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appointment_summary: Schema.Attribute.Component<'appointment.appointment-summary', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    date_time_select: Schema.Attribute.Component<'general.date-time-select', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCategoryPlaceCategoryPlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::category-place.category-place'> &
      Schema.Attribute.Private;
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::discount.discount'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    number: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<0>;
...
export interface ApiDistrictDistrict extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    code: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.Unique;
    codename: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    division_type: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::district.district'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    province: Schema.Attribute.Relation<'manyToOne', 'api::province.province'>;
    publishedAt: Schema.Attribute.DateTime;
    short_codename: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::homepage.homepage'> &
      Schema.Attribute.Private;
    main_categories: Schema.Attribute.Component<'homepage.main-category', false>;
    metadata: Schema.Attribute.Component<'general.metadata', false>;
    places: Schema.Attribute.Relation<'oneToMany', 'api::place.place'>;
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category_places: Schema.Attribute.Relation<'manyToMany', 'api::category-place.category-place'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    discount: Schema.Attribute.Relation<'manyToOne', 'api::discount.discount'>;
    general_info: Schema.Attribute.Component<'place.general-info', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::place.place'> &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.Component<'general.metadata', false>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    payment_methods: Schema.Attribute.Relation<'oneToMany', 'api::payment-method.payment-method'>;
    place_owner: Schema.Attribute.Component<'place.place-owner', false>;
    publishedAt: Schema.Attribute.DateTime;
    quantity_sold: Schema.Attribute.Integer & Schema.Attribute.Required;
    reviews: Schema.Attribute.Component<'place.review', true>;
    service_group_description: Schema.Attribute.Blocks;
...
export interface ApiProvinceProvince extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::province.province'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    phone_code: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact_info: Schema.Attribute.Component<'general.contact-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    logo_mobile: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
