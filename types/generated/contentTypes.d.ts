...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appointment_summary: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_time_select: Schema.Attribute.Component<
      'general.date-time-select',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiCategoryPlaceCategoryPlace
  extends Struct.CollectionTypeSchema {
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_categories: Schema.Attribute.Component<
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category_places: Schema.Attribute.Relation<
      'manyToMany',
      'api::category-place.category-place'
    >;
    createdAt: Schema.Attribute.DateTime;
